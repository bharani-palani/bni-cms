  ...
  const handleCreateFolder = () => {
    if (newFileFolder) {
      ...
      userContext.renderToast({
        ...
        message: 'Folder name cant be empty',
      });
    }
  };
        ...
        {(createFolder || rename) && (
          <div className="input-group input-group-sm">
            ...
            <input
              ...
              placeholder={
                createFolder ? 'New folder' : 'Rename file or folder'
              }
        ...
        <div className={`responsive-gallery-grid ${view}-grid`}>
          {view === 'list' && data.length > 0 && (
            <div className={`child ${view}-child`}>
              <div></div>
              <div className="title ps-2">File name</div>
              <div className="title ps-2">File size</div>
